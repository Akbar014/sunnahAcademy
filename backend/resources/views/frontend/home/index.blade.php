...
@section('content')
    ...
    @include('frontend.home.component.prayer_time')
        <!-- About Satrt -->
        ...
        <div class="container-fluid event py-5">
            <div class="container py-5">
                ...
                <div class="row g-4 event-item wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="overflow-hidden mb-5">
                            <img src="{{ asset('/assets') }}/img/events-1.jpg" class="img-fluid w-100" alt="">
                        </div>
                    </div>
                </div>
                <div class="row g-4 event-item wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="overflow-hidden mb-5">
                            <img src="{{ asset('/assets') }}/img/events-2.jpg" class="img-fluid w-100" alt="">
                        </div>
                    </div>
                </div>
                <div class="row g-4 event-item wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="overflow-hidden mb-5">
                            <img src="{{ asset('/assets') }}/img/events-3.jpg" class="img-fluid w-100" alt="">
                        </div>
                    </div>
                </div>
            </div>
